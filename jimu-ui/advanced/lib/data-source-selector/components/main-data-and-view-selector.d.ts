...
export declare const MainDataAndViewSelector: React.FC<import("react-intl").WithIntlProps<ReactRedux.Omit<React.ClassAttributes<_MainDataAndViewSelector> & MainDataAndViewSelectorProps & ExtraProps & StateToProps, "browserSizeMode"> & MainDataAndViewSelectorProps>> & {
    WrappedComponent: React.ComponentType<ReactRedux.Omit<React.ClassAttributes<_MainDataAndViewSelector> & MainDataAndViewSelectorProps & ExtraProps & StateToProps, "browserSizeMode"> & MainDataAndViewSelectorProps>;
};
export {};
