import { IField, IFieldInfo, IItem } from '@esri/arcgis-rest-types';
...
/**
 * Create a JS API layer from a data source, the layer will use the same filter with the data source.
 * Always create a new JS API layer even if the data source has a JS API layer.
 */
export declare function createJSAPILayerByDataSource(ds: FeatureLayerDataSource | SceneLayerDataSource): Promise<__esri.FeatureLayer | __esri.SceneLayer>;
