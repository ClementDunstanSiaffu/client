...
import layerListIcon from 'jimu-icons/svg/outlined/brand/widget-layerlist.svg'
...
export default class Widget extends React.PureComponent<WidgetProps, WidgetState> {
  ...
  registerLayerListActions () {
    this.layerListActions = [
      ...
      new Label(this, this.props.intl.formatMessage({ id: 'showLabels', defaultMessage: defaultMessages.showLabels }), true),
      new Label(this, this.props.intl.formatMessage({ id: 'hideLabels', defaultMessage: defaultMessages.hideLabels }), false),
