...
import {
  ...
  ThemeVariables, css, polished, getAppStore, IntlShape, SerializedStyles
} from 'jimu-core'
...
export class MapPopper extends React.PureComponent<Props, States> {
  ...
  //      this.setState({isDisableDraw: true})
  //     } else {
  //       this.setState({isDisableDraw: false})
  //     }
  //  }
  // }
  ...
  getPoperStyle = (theme: ThemeVariables): SerializedStyles => {
    return css`
        .popper-content {
          width: 100%;
          height: 100%;
  ...
  render (): React.ReactElement {
    ...
    if (utils.isDefined(this.props.jimuMapView?.dataSourceId)) {
      ...
      jimuMapConfig = Immutable({} as any).set('initialMapDataSourceID', initialMapDataSourceID).set('toolConifg', toolConfig)
    }
            ...
            <div className='popper-footer'>
              <div className='left-tool'>
                <ActionPanel
                  ...
                  isDisableDraw={this.state.isDisableDraw}
