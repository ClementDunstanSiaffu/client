...
import widgetFlyControllerOutlined from 'jimu-icons/svg/outlined/brand/widget-fly-controller.svg'
...
export default class Widget extends React.PureComponent<AllWidgetProps<IMConfig> & ExtraStateProps, State> {
  ...
  renderWidgetPlaceholder (): React.ReactElement {
    return <WidgetPlaceholder icon={widgetFlyControllerOutlined} widgetId={this.props.id} message={this.state.errorTip} css={getWidgetPlaceholderStyle()} />
  }
