...
import { React, css, jsx, Immutable, polished, IMThemeSliderVariant, ThemeVariables } from 'jimu-core'
...
import { NavigationVariant, MultiSelect, Select, Radio, Label, Switch, TextInput, NumericInput, hooks, defaultMessages as jimuiDefaultMessage } from 'jimu-ui'
...

        {
          type === 'navButtonGroup' && <React.Fragment>
            <SettingRow flow="wrap" label={translate('previous')} className="justify-content-between">
              ...
              <IconPicker configurableOption={'none'} icon={previousIcon as any} onChange={(icon) => onSettingConfigChange(['display', 'standard', 'previousIcon'], icon)}></IconPicker>
            </SettingRow>
            ...
            <SettingRow flow="wrap" label={translate('next')} className="justify-content-between">
              ...
              <IconPicker configurableOption={'none'} icon={nextIcon as any} onChange={(icon) => onSettingConfigChange(['display', 'standard', 'nextIcon'], icon)}></IconPicker>
            </SettingRow>
