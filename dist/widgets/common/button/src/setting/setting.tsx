...
import {
  ...
  ThemeButtonStyles, IconProps, LinkType, Expression
} from 'jimu-core'
            ...
            <SettingSection>
              ...
              <SettingRow label={this.props.intl.formatMessage({ id: 'icon', defaultMessage: jimuCoreMessages.icon })}>
                <IconPicker icon={icon} configurableOption={'none'} onChange={this.onIconResultChange}
                  aria-label={this.props.intl.formatMessage({ id: 'icon', defaultMessage: jimuCoreMessages.icon })}
                />
              </SettingRow>
              {
                isPositionOpen &&
            ...
            <SettingSection className='px-14'>
              ...
              >
                <Tabs fill type='pills' onChange={this.onAdvanceTabSelect} defaultValue={SettingTabs.regular}>
                  <Tab className='tab-label' id={SettingTabs.regular} title={this.props.intl.formatMessage({ id: 'regular', defaultMessage: jimuUIMessages.regular })}>
