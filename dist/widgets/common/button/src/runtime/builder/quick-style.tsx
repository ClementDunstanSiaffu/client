/** @jsx jsx */
import { React, jsx, ThemeButtonType, IntlShape, injectIntl, css, ThemeVariables, SerializedStyles, ImmutableObject, classNames, polished, WidgetInitResizeCallback, WidgetInitDragCallback } from 'jimu-core'
  ...
  render () {
    return (
      <QuickStylePopper reference={this.props.reference} open={true} placement="right-start"
        css={this.getStyle(getBuilderThemeVariables())} onClose={this.props.onClose}
