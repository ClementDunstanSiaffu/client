exports.getCommon = function (commonOptions = {}) {
  ...
  const jsApiUrl = process.env.ARCGIS_JSAPI_URL || 'https://js.arcgis.com/4.24/';
  ...
  function isRequestExternal(request){
    ...
    const fullMatchPackages = [
      ...
      'jimu-ui/advanced/theme-components', 'jimu-ui/advanced/map', 'jimu-ui/advanced/chart', 'jimu-ui/advanced/coordinate-control', 'arcgis-charts', 'calcite-components'
