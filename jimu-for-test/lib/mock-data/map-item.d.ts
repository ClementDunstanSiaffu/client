 ...
 */
export declare const mapItemWithOneFeatureLayer: MockItemData;
/**
 * Mocked map item. The map item contains one map service layer, the map service layer is added by url.
 */
export declare const mapItemWithOneMapServiceLayer: MockItemData;
/**
 ...
 */
export declare const mapItemWithOneFeatureCollectionHasTwoLayersDirectlySavedInMap: MockItemData;
/**
 ...
 */
export declare const mapItemWithOneFeatureCollectionHasOneLayerDirectlySavedInMap: MockItemData;
/**
 * Mocked map item. The map item contains one feature collection item and the item contains two feature layers.
 */
export declare const mapItemWithOneFeaureCollectionItemHasTwoLayers: MockItemData;
/**
 * Mocked map item. The map item contains one feature collection item and the item contains one feature layer.
 */
export declare const mapItemWithOneFeaureCollectionItemHasOneLayer: MockItemData;
/**
 * Mocked map item. The map item contains one group and the group contains one feature layer.
 */
export declare const mapItemWithOneGroupHasOneLayer: MockItemData;
