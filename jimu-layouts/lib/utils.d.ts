import { IMLayoutJson, IMBoundingBox, IMState, IMAppConfig, IMLayoutItemJson, BrowserSizeMode, PagePart, LayoutItemConstructorProps, BoundingBox } from 'jimu-core';
...
export declare function autoBindHandlers(el: Record<string, any>, fns: string[]): void;
/**
 ...
 * @param containerRect
 */
export declare function updateBoundingBoxProp(prop: string, b: IMBoundingBox, newValue: number | string, containerRect: ClientRect): IMBoundingBox;
...
export declare function normalizeLinearUnit(value: string | LinearUnit): string;
