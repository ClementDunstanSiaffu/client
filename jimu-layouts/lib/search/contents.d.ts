import { IMAppConfig, IMLayoutJson, LayoutItemType, IMLayoutItemJson, LayoutInfo, BrowserSizeMode, ContainerType, IMSizeModeLayoutJson, LayoutItemJson, ImmutableObject, RootContainerType } from 'jimu-core';
import { LayoutStructure } from './layout-map';
 ...
 * @param layoutId
 */
export declare function findParentViewId(layoutId: string, structure: ImmutableObject<LayoutStructure>): {
    viewId: string;
    sectionId: string;
};
export declare function findParentScreenId(layoutId: string, structure: ImmutableObject<LayoutStructure>): {
    screenId: string;
...
export declare function getContentRootContainerInfo(appConfig: IMAppConfig, id: string, type: LayoutItemType, sizeMode: BrowserSizeMode): {
